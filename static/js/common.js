...
function setCopy(text, msg) {
  ...
  if (success) {
    ...
    if (r) {
      ...
      showDialog('<div class="c"><div style="width: 200px; text-align: center;">澶嶅埗澶辫触锛岃閫夋嫨鈥滃厑璁歌闂€�</div></div>', 'alert');
    }
  } else {
    var msg = '<div class="c"><div style="width: 200px; text-align: center; text-decoration:underline;">鐐规澶嶅埗鍒板壀璐存澘</div>' + AC_FL_RunContent('id', 'clipboardswf', 'name', 'clipboardswf', 'devicefont', 'false', 'width', '200', 'height', '40', 'src', STATICURL + 'image/common/clipboard.swf', 'menu', 'false', 'allowScriptAccess', 'sameDomain', 'swLiveConnect', 'true', 'wmode', 'transparent', 'style', 'margin-top:-20px') + '</div>';
    showDialog(msg, 'info');
